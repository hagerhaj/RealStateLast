...
Public Class SumPaidBetwRep

    Private Sub SumPaidBetwRep_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            ReportViewer1.ServerReport.ReportPath = "/SumPaidBetwwen/Report1"
